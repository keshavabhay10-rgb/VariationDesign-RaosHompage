  ...
  return (
    <section ref={containerRef} className="h-[300vh] relative" id="home">
      <div ref={heroRef} className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-bg-primary">
        ...
        <div
          ref={portalRef}
          className="relative z-[2] w-[340px] h-[460px] border-[3px] border-gold rounded-[170px_170px_12px_12px] overflow-hidden shadow-[0_0_60px_rgba(201,150,59,0.2),inset_0_0_30px_rgba(201,150,59,0.1)]
          before:content-[''] before:absolute before:inset-[-6px] before:border before:border-gold/30 before:rounded-[176px_176px_18px_18px] before:pointer-events-none
        ...
        <div ref={textLeftRef} className="absolute left-[5%] top-1/2 -translate-y-1/2 z-[3] max-md:left-1/2 max-md:-translate-x-1/2 max-md:top-[18%] max-md:text-center max-md:w-[90%]">
          <h1 className="font-display text-[clamp(2rem,5vw,4.5rem)] font-bold leading-[1.05] text-text-primary">
            Where<br />Tradition<br />Meets <em className="italic text-gold">Modern</em><br />Flavours
          </h1>
        </div>
        ...
        <div ref={textRightRef} className="absolute right-[5%] top-1/2 -translate-y-1/2 z-[3] text-right max-md:right-auto max-md:left-1/2 max-md:-translate-x-1/2 max-md:top-auto max-md:bottom-[20%] max-md:text-center max-md:w-[90%]">
          <h2 className="font-display text-[clamp(1.5rem,3.5vw,3.5rem)] font-normal text-text-secondary tracking-wide">
            Indian <span className="text-gold font-semibold">Fusion</span><br />Dalston
          </h2>
        </div>

        {/* Scroll prompt */}
        <div ref={scrollPromptRef} className="absolute bottom-24 left-1/2 -translate-x-1/2 z-[5] text-center max-md:hidden">
          <p className="text-[0.7rem] tracking-[0.2em] uppercase text-text-secondary mb-3">
            Scroll to begin your experience
          </p>
          <div className="w-5 h-5 mx-auto border-r-[1.5px] border-b-[1.5px] border-gold rotate-45 animate-chevron-bounce" />
        </div>
        ...
        >
          <span className="font-display text-[clamp(1.5rem,3vw,2.5rem)] text-gold tracking-[0.2em] uppercase block mb-4 drop-shadow-[0_2px_20px_rgba(0,0,0,0.6)]">
          ...
          <div className="w-[60px] h-px bg-gold mx-auto mb-6 opacity-60" />
          <span className="font-body text-xs tracking-[0.2em] uppercase text-[#D4CFC8] drop-shadow-[0_1px_10px_rgba(0,0,0,0.5)]">
            Indian Fusion Dining &middot; Dalston, London
          </span>
          <div className="mt-8 font-display italic text-sm text-gold tracking-wide drop-shadow-[0_1px_10px_rgba(0,0,0,0.5)]">
            From Our Tandoor
          </div>
        </div>
      </div>
